...
class FSQ(nn.Module):
    def __init__(self, levels: List[int], dim: int):
        ...
        # NOTE customized from Lucidrains' implementation
        # include projection layer to match the dimension of the input
        self.project_in = nn.Linear(dim, self.dim)
        self.project_out = nn.Linear(self.dim, dim)
        self.codebook_size = self.n_codes
    ...
    def forward(self, z: Tensor) -> Tensor:
        ...
        return zhat, indices, torch.zeros(1, device=z.device)
